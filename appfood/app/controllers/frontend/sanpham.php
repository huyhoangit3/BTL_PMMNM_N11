	...
	public function payment(){
		...
		if(isset($_COOKIE['cms_cookie_cart_'.CMS_CODE])){
			...
			if($this->input->post('submit')){
				...
				$this->form_validation->set_rules('data[phone]', 'Điện thoại', 'trim|required|regex_match[/^[0-9]{10}$/]');
									...
									<table width="700" border="1" cellspacing="0" cellpadding="5" align="center" style="border:1px solid #efefef;border-collapse:collapse">
										<thead>
											<tr style="background:#00918c">
												...
												<td style="text-align:center;font-family:tahoma;font-size:14px;color:#fff">Tổng tạm</td>
											</tr>
										</thead>
										<tbody>
											'.$chitietdon.'
