            ...
            <article class="col-main">
              <div class="toolbar">
                <div class="display-product-option">
                  ...
                  <div class="pages">
                    <label style="color: #333e48; font-size: 18px;font-weight: 600;line-height: normal;margin: 0;padding: 10px 0px 0px 0px;position: relative;font-family: 'IBM Plex Sans', sans-serif;text-transform: uppercase;letter-spacing: 0.5px">CÓ TẤT CẢ : <?php echo count($list); ?> SẢN PHẨM Ở TRANG NÀY</label>

                  </div>
                  <?php }else{ ?>
                     <div class="pages">
                      <label style="color: #333e48; font-size: 18px;font-weight: 600;line-height: normal;margin: 0;padding: 10px 0px 0px 0px;position: relative;font-family: 'IBM Plex Sans', sans-serif;text-transform: uppercase;letter-spacing: 0.5px">  CHƯA CÓ SẢN PHẨM NÀO</label>
                    </div>
                  <?php } ?>
                    ...
                    <div class="sort-by">
                      ...
                      <form action="" method="POST">
                            <select class="input-select" name="sort" id="" onchange="this.form.submit()">
                                ...
                                <option value="id_desc" <?php if ($_SESSION['sort'] == 'id_desc') {
                                                            echo "selected";
                                                        } ?>>-- Hiển thị sắp xếp --</option>
                                <option value="price_asc" <?php if ($_SESSION['sort'] == 'price_asc') {
                                                                echo "selected";
                                                            } ?>>Giá tăng dần</option>
                                <option value="price_desc" <?php if ($_SESSION['sort'] == 'price_desc') {
                                                                echo "selected";
                                                            } ?>>Giá giảm dần</option>
                                <option value="title_asc" <?php if ($_SESSION['sort'] == 'title_asc') {
                                                                echo "selected";
                                                            } ?>>Theo tên A->Z</option>
                                <option value="title_desc" <?php if ($_SESSION['sort'] == 'title_desc') {
                                                                echo "selected";
                                                            } ?>>Theo tên Z->A</option>
                                <option value="viewed_desc" <?php if ($_SESSION['sort'] == 'viewed_desc') {
                                                                echo "selected";
              ...
              <div class="toolbar">
                <div class="display-product-option">
                  ...
                  <div class="pages" style="margin: 0 auto;text-align: center; display: block;>">
