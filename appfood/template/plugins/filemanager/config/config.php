...
*/
    ...
    mkdir('../../../upload/thumb/', 0777, true);
	}
	$base_url_cu=((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'];
	$config = array(
	...
	*/
	...
	'hidden_folders'                          => array('slider', 'thumbs'),
	...
	'fixed_path_from_filemanager'             => array( '../../../upload/thumb/', '../../../upload/thumb/', '../../../upload/thumb/', '../../../upload/thumb/'), //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => array('small_', 'medium_', 'large_', 'wide_'), //name to prepend on filename
	'fixed_image_creation_to_append'          => array('', '', ''), //name to appendon filename
	'fixed_image_creation_width'              => array( 150, 350, 600, 600 ), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array( 150, 350, 600, 200 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	 */
	'fixed_image_creation_option'             => array( 'crop', 'crop', 'crop', 'crop' ), //set the type of the crop
